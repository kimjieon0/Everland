...
public class 에버랜드 {
	...
	public static void main(String[] args) {
		...
		int todayYear, todayDate, birthYear, birthMonth, birthDay, birthDate, reservationDate, benefit, count = 0, manAge, price = 0;
		String ticket, socialNumber, age = null ;
        String b = "";
        int addOrder = 0 ;
        int orderCount = 0;
        String[] newTicket = new String[100];
        String[] newAge = new String[100];
        int[] newCount = new int[100];
        int[] newPrice = new int[100];
        String[] newb = new String[100];
	    ...
	    while(true ) {
			...
			if(ticket == "A 티켓") {
				...
				newAge[orderCount] = age;
				newCount[orderCount] = count;
				newPrice[orderCount] = price;
				newb[orderCount] = b;
				orderCount++;
				...
				for (int index = 0; index < orderCount; index++) {
					System.out.printf("%s  %s  X  %d  %d  %s\n", newTicket[index], newAge[index], newCount[index], newPrice[index]*newCount[index], newb[index]);}
				System.out.println("======================================");
			break;
		}		
	}		    
